...
const targets: BinaryTarget[] = [
	...
	},
	{
		...
		outfile: "packages/coding-agent/binaries/musepi-linux-x64",
	},
	{
		id: "linux-arm64",
		platform: "linux",
		...
		outfile: "packages/coding-agent/binaries/musepi-linux-arm64",
	},
	{
		id: "linux-musl-x64",
		platform: "linux",
		...
		outfile: "packages/coding-agent/binaries/musepi-linux-musl-x64",
	},
	{
		id: "linux-musl-arm64",
		platform: "linux",
		...
		outfile: "packages/coding-agent/binaries/musepi-linux-musl-arm64",
	},
	{
		id: "win32-x64",
		platform: "win32",
		...
		outfile: "packages/coding-agent/binaries/musepi-windows-x64.exe",
	},
];
...
async function generateBundle(): Promise<void> {
	if (isDryRun) {
		...
		console.log("DRY RUN bun --cwd=packages/guest-client run gen:tool-views");
		return;
	}
	await runCommand(["bun", "run", "gen:stats"], repoRoot);
	await runCommand(["bun", "--cwd=packages/guest-client", "run", "gen:tool-views"], repoRoot);
}
