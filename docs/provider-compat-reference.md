...
- [Provider endpoint constraints](./provider-endpoint-constraints.html) — where a new constraint should live
...
- [Model and Provider Configuration](./models.html) — `models.yml` and user-facing `compat` overrides
