...
## Side Effects
- Filesystem: writes or deletes files under `~/.musepi/agent/managed-skills`.
- Network: none.
...
## Notes
- Managed skills are generated under `~/.musepi/agent/managed-skills` and never edit user-authored skills.
