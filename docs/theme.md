...
- syntax highlighting colors used by native highlighter (`@musepi/pi-natives`)
...
- default agent dir: `~/.musepi/agent`
- effective default file: `~/.musepi/agent/config.yml`
...
1. Create file in custom themes dir, e.g. `~/.musepi/agent/themes/my-theme.json`.
