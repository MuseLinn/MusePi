 ...
 *
 * Routes through @musepi/pi-ai (`completeSimple`) rather than raw HTTP so model
...
import { completeSimple } from "@musepi/pi-ai";
import type { Api, AssistantMessage, Model } from "@musepi/pi-ai";
