...
export const tools = {
	...
	"browser relay serving waiting":
		"Relay is running, waiting for the extension — load it unpacked in chrome://extensions",
	...
	"browser bridge info": "Port {port} · {tabs} tabs",
	"browser bridge offline": "Not running",
	"browser viewport presets": "Viewport presets",
	"browser viewport width": "Viewport width (drag sideways)",
	"browser viewport height": "Viewport height (drag vertically)",
	"browser zoom in": "Zoom in",
	"browser zoom out": "Zoom out",
	"browser reset zoom": "Reset zoom (click to return to 100%)",
	"browser page loading": "Loading page…",
	"agent operating": "Agent operating",
	...
	"ext slot diagnostics": "Slot diagnostics",
	"ext stat total": "Total capabilities",
	"ext stat active": "Active",
	"ext stat failed": "Load failures",
	"ext stat unhosted": "Unhosted slots",
	"ext stat total sub {kinds} {sources}": "{kinds} kinds · {sources} sources",
	"ext stat active sub {n}": "{n} disabled or shadowed",
	"ext stat unhosted sub ok {total}": "all {total} slots hosted",
	"ext needs attention": "Needs attention",
	"ext open diagnostics": "View diagnostics",
	"ext view details": "View details",
	"ext needs attention empty": "All clear — no load errors or shadowed items",
	...
	"skill tab versions": "Versions",
	"skill invoke": "Use in session",
	"skill invoke copied": "Copied — paste it in a session",
	"skill disable": "Disable",
	"skill overview summary": "Summary",
	"skill kv source group": "Source & version",
	"skill kv source": "Source",
	"skill kv level": "Level",
	"skill kv path": "Installed at",
	"skill kv path virtual": "Declared by an extension (no file)",
	"skill versions empty": "No version history yet",
	"skill risk body":
		"Uninstalling deletes the skill's folder, including its scripts and assets. This cannot be undone.",
