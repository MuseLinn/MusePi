...
export const transcript = {
	...
	"run read {count}": "Read {count} files",
	"run edit {count}": "Edited {count} files",
	"run command {count}": "Ran {count} commands",
	"run other {count}": "{count} other operations",
	// ── Transcript ────────────────────────────────────────────────────────────
	" · redacted": " · redacted",
	...
	"turn map title": "Session map",
	"turn map turns count": "{count} turns",
	"turn map replies": "{count} replies",
	"turn map tools": "{count} tools",
	"turn map branch from": "from Turn {turn} · re-answer",
	"turn map layout vertical": "Vertical layout",
