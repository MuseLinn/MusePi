...
export const settings = {
	...
	"import grouped": "Grouped into {count} group(s) by workspace",
	...
	"workspace memory description":
		"Save and reuse long-term context per workspace; takes effect in new sessions. May increase model calls and token cost.",
	...
	"voice native stt": "On-device speech recognition",
	"voice native tts": "On-device speech synthesis",
	"voice native status ok": "Supported on this device",
	"voice native status no": "Not supported on this device",
	"voice guide native retry": "Use on-device recognition",
	"voice native badge": "On-device",
	"voice output engine": "Speech engine",
	"voice engine auto": "Auto",
	"voice engine daemon": "Daemon",
	"voice engine native": "On-device",
	"voice engine auto desc": "Prefer daemon Kokoro; falls back to the system voice when the daemon is absent",
	"voice default": "Default",
	"voice preview": "Preview",
	"voice native voices": "System voices",
	"voice system default": "System default",
	"voice model downloading": "Downloading…",
	"voice model percent": "Downloading {percent}%",
	"voice model download failed": "Download failed",
	"board delete": "Delete",
	"board resume": "Resume",
	"board pause": "Pause",
	...
	"task calendar month": "{month}/{year}",
	"scheduled date full": "{month}/{day}/{year}",
	"scheduled next run at": "{month}/{day} {time}",
	"scheduled last error": "Last error",
	"task run history": "Run history",
	"scheduled tz local": "Host timezone",
	...
	refresh: "Refresh",
	mcp: "MCP",
	"needs host channel": "Needs a host data channel — not wired yet",
	...
	"pet bubbles hide": "Hide",
	"pet bubbles show": "Show messages",
	"pet bubbles clear all": "Clear all",
	"pet bubbles more": "{count} more",
	"pet session working": "Working…",
	"pet session using tool": "Using {tool}…",
	"pet session done": "Done",
	"pet session error": "Failed",
	"pet session untitled": "Untitled session",
	"pet bubble kind completed": "Done",
	"pet bubble kind error": "Failed",
	"pet bubble kind question": "Needs answer",
	"pet bubble kind subtask": "Subtask",
	"pet bubble confirm": "Done",
	"pet bubble reply": "Reply",
	"pet bubble deny": "Deny",
	"pet bubble stop": "Stop",
	...
	"cmd s to save": "⌘S / Ctrl+S to save",
	"discard changes and close editor": "Discard changes and close the editor",
	"file too large to edit": "File too large to edit in-app",
	"unsupported edit": "This format has no in-app editor — use Open with default app",
	"only first {n} rows shown": "Only the first {n} rows are shown",
	...
	"onboarding title main1": "Language & appearance",
	"onboarding step main1": "Pick the interface language, theme and accent — changeable anytime.",
	"onboarding title done": "All set",
	"onboarding step done":
		"Send your first message whenever you like. The items below are optional — do them now or later in settings.",
	"onboarding branches label": "Optional setup",
