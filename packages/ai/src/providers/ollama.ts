import { fetchWithRetry, parseStreamingJson, readJsonl } from "@musepi/pi-utils";
...
const streamOllamaOnce = (
	...
	void (async () => {
		...
		try {
			...
			for await (const chunk of readJsonl<OllamaChatChunk>(response.body as ReadableStream<Uint8Array>)) {
