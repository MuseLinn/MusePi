...
| `modes/interactive/components/checkbox-selector.ts` | Multi-select checkbox UI for import |
| `modes/interactive/components/setup-wizard.ts` | Step-by-step setup wizard |
