...
| Package | Purpose |
|---------|---------|
| `@muselinn/musepi` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
...
```typescript
import { isToolCallEventType } from "@muselinn/musepi";
...
```typescript
import { isBashToolResult } from "@muselinn/musepi";
...
```typescript
import { createLocalBashOperations } from "@muselinn/musepi";
...
```typescript
import { CONFIG_DIR_NAME, type ExtensionAPI } from "@muselinn/musepi";
...
```typescript
import { SessionManager } from "@muselinn/musepi";
...
```typescript
import { withFileMutationQueue } from "@muselinn/musepi";
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@muselinn/musepi";
...
```typescript
import { createBashTool } from "@muselinn/musepi";
...
```typescript
import { keyHint } from "@muselinn/musepi";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@muselinn/musepi";
