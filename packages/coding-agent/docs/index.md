...
```bash
npm uninstall -g @muselinn/musepi
```

For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @muselinn/musepi`, `yarn global remove @muselinn/musepi`, or `bun uninstall -g @muselinn/musepi`.
