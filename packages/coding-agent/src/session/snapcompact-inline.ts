...
import type { Context, ImageContent, Model, TextContent, ToolResultMessage, UserMessage } from "@musepi/pi-ai";
...
// Per-provider image-count budgets live in @musepi/snapcompact
