...
import { type ApiKeyResolver, completeSimple } from "@musepi/pi-ai";
import { hostMatchesUrl } from "@musepi/pi-catalog/hosts";
import type { Mnemopi } from "@musepi/pi-mnemopi";
import type * as MnemopiDiagnoseNs from "@musepi/pi-mnemopi/diagnose";
import type { DiagnosticSummary } from "@musepi/pi-mnemopi/diagnose";
...
async function loadMnemopiDiagnose(): Promise<typeof MnemopiDiagnoseNs> {
	if (!mnemopiDiagnoseMod) {
		mnemopiDiagnoseMod = await import("@musepi/pi-mnemopi/diagnose");
	}
