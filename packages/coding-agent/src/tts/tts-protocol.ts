...
export type TtsWorkerInbound =
	| { type: "ping"; id: string }
	| { type: "synthesize"; id: string; modelKey: TtsLocalModelKey; text: string; voice?: string; rate?: number }
	...
	| { type: "stream-start"; id: string; modelKey: TtsLocalModelKey; voice?: string; rate?: number }
