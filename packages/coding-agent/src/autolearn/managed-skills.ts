 ...
 * isolated directory (`~/.musepi/agent/managed-skills`) separate from
 * user-authored skills (`~/.musepi/agent/skills`). They are discovered and
...
/** Resolve the isolated managed-skills directory (`~/.musepi/agent/managed-skills`). */
