import type { AutocompleteItem } from "@musepi/pi-tui";
...
function materializeTuiBuiltinSlashCommand(
	...
	if (runtime && cmd.getTuiAutocompleteDescription) {
		...
		// Translate the static description at render time (not module load): the
		// locale may not be applied yet when this module initializes, and the
		// user can switch languages at runtime.
