 ...
 */
import { type ApiKey, type FetchImpl, withAuth } from "@musepi/pi-ai";
import type { Api, Model, RemoteCompactionConfig } from "@musepi/pi-ai/types";
 ...
 * `qwen-template-false` dialect; musepi emits `preserve_thinking` inside
