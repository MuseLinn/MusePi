/**
 * `musepi completions <bash|zsh|fish>` — print a shell completion script.
 *
...
import { APP_NAME, VERSION } from "@musepi/pi-utils";
import { Args, type CliConfig, Command, type CommandCtor } from "@musepi/pi-utils/cli";
