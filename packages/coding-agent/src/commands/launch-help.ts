import { Args, type CommandMetadata, Flags } from "@musepi/pi-utils/cli";
import { APP_NAME } from "@musepi/pi-utils/dirs";
...
export const launchHelp = {
	...
	examples: [
		...
		`# Export a session file to HTML\n  ${APP_NAME} --export ~/.musepi/agent/sessions/--path--/session.jsonl`,
	],
