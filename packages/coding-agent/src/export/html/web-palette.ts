/** musepi web palette bundled into standalone exports and the share viewer. */
...
export const WEB_EXPORT_PALETTES = {
	dark: {
		...
		"--fg-faint": "#6e6974",
		"--accent": "#d9a441",
		"--accent-muted": "oklch(0.7507 0.1295 79.85 / 18%)",
		"--ok": "#68ca80",
		"--err": "#f05653",
		"--warn": "#e4b33f",
	...
	light: {
		...
		"--accent": "oklch(0.62 0.115 79.85)",
		"--accent-muted": "oklch(0.62 0.115 79.85 / 14%)",
