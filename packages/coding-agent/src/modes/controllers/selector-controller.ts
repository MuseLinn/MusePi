...
import type { Component, OverlayHandle } from "@musepi/pi-tui";
import { Loader, Spacer, setTuiTight, Text } from "@musepi/pi-tui";
import { getAgentDbPath, getAgentDir, getProjectDir, normalizePathForComparison } from "@musepi/pi-utils";
import {
...
import { invalidateSettingDefsCache } from "../components/settings-defs.js";
	...
	handleSettingChange(id: string, value: unknown): void {
		...
		switch (id) {
			...
			case "settings.locale": {
				...
				this.#settingsSelector?.refreshLocale();
				this.ctx.ui.invalidate();
				this.ctx.ui.requestRender();
				break;
			}
