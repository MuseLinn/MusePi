import type { AuthInfoLink, OAuthDeviceCodeInfo } from "@musepi/pi-ai";
import { Container, type Focusable, getKeybindings, Input, Spacer, Text, type TUI } from "@musepi/pi-tui";
