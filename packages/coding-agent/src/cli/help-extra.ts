import "@musepi/pi-utils/env";
import chalk from "@musepi/pi-utils/chalk";
import { APP_NAME, CONFIG_DIR_NAME } from "@musepi/pi-utils/dirs";
...
${chalk.bold("Useful Commands:")}
  musepi agents unpack           - Export bundled subagents to ~/.musepi/agent/agents (default)
  musepi agents unpack --project - Export bundled subagents to ./.musepi/agents`;
}
