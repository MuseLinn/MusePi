import type { CommandMetadata } from "@musepi/pi-utils/cli";

export const acpHelp = {
	description: "Run MusePi as an ACP (Agent Client Protocol) server over stdio",
} satisfies CommandMetadata;

export const agentsHelp = { description: "Manage bundled task agents" } satisfies CommandMetadata;

export const serveHelp = {
	description: "Start the MusePi daemon (unix socket JSON-RPC)",
} satisfies CommandMetadata;
...
export const importHelp = {
	description: "Import sessions from another coding-agent (claude, codex, opencode, grok, kimicode, musepi, omp, pi)",
} satisfies CommandMetadata;
...
export const worktreeHelp = {
	description: "List or clear agent-managed git worktrees (~/.musepi/wt)",
} satisfies CommandMetadata;
