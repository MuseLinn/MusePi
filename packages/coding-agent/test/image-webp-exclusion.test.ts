...
import type { Api, Message, Model } from "@musepi/pi-ai";
import { buildResponsesInput } from "@musepi/pi-ai/providers/openai-shared";
import { buildModel } from "@musepi/pi-catalog/build";
import { getBundledModels } from "@musepi/pi-catalog/models";
import type { CustomMessage } from "@musepi/pi-coding-agent/session/messages";
import { SessionProviderBoundary } from "@musepi/pi-coding-agent/session/session-provider-boundary";
import {
	modelLacksWebpSupport,
	normalizeModelContextImages,
	normalizeModelContextMessages,
	webpExclusionForModel,
} from "@musepi/pi-coding-agent/utils/image-loading";
