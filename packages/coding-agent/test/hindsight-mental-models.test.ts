...
import type { BankScope } from "@musepi/pi-coding-agent/hindsight/bank";
import {
	type HindsightApi,
	HindsightApi as HindsightApiCtor,
	type MentalModelSummary,
} from "@musepi/pi-coding-agent/hindsight/client";
import {
...
} from "@musepi/pi-coding-agent/hindsight/mental-models";
