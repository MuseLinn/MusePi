...
import { defineRpcClientTool, RpcClient } from "@musepi/pi-coding-agent/modes";
import { RpcHostToolBridge } from "@musepi/pi-coding-agent/modes/rpc/host-tools";
import type {
	RpcHostToolCallRequest,
	RpcHostToolCancelRequest,
	RpcHostToolUpdate,
} from "@musepi/pi-coding-agent/modes/rpc/rpc-types";
