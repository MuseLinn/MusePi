...
import { type CompactionPreparation, resolveThresholdTokens, shouldCompact } from "@musepi/pi-agent-core/compaction";
...
import type { CompactionEntry } from "@musepi/pi-coding-agent/session/session-entries";
