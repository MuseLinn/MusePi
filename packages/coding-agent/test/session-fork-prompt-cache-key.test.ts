...
import type { ScopedModel } from "@musepi/pi-coding-agent/config/model-resolver";
import { Settings } from "@musepi/pi-coding-agent/config/settings";
import { buildSessionOptions } from "@musepi/pi-coding-agent/main";
import { type CreateAgentSessionOptions, createAgentSession } from "@musepi/pi-coding-agent/sdk";
...
import { CURRENT_SESSION_VERSION, type SessionHeader } from "@musepi/pi-coding-agent/session/session-entries";
