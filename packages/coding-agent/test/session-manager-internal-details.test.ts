...
import { type SkillPromptDetails, stripInternalDetailsFields } from "@musepi/pi-coding-agent/session/messages";
import type { CustomMessageEntry } from "@musepi/pi-coding-agent/session/session-entries";
