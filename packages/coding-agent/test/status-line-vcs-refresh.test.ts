...
import type { StatusLineSettings } from "@musepi/pi-coding-agent/modes/components/status-line";
...
import type { GitHeadState, GitRefHead, GitRepository } from "@musepi/pi-coding-agent/utils/git";
