...
import { handleCheatSh } from "@musepi/pi-coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@musepi/pi-coding-agent/web/scrapers/rfc";
import { handleTldr } from "@musepi/pi-coding-agent/web/scrapers/tldr";
