...
import { handleArtifactHub } from "@musepi/pi-coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@musepi/pi-coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@musepi/pi-coding-agent/web/scrapers/discogs";
