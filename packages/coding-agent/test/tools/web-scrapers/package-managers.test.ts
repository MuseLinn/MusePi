...
import { handleAur } from "@musepi/pi-coding-agent/web/scrapers/aur";
import { handleBrew } from "@musepi/pi-coding-agent/web/scrapers/brew";
import { handleMaven } from "@musepi/pi-coding-agent/web/scrapers/maven";
import { handleNuGet } from "@musepi/pi-coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@musepi/pi-coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@musepi/pi-coding-agent/web/scrapers/rubygems";
