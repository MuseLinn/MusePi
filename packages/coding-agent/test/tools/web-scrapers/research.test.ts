...
import { handleBiorxiv } from "@musepi/pi-coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@musepi/pi-coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@musepi/pi-coding-agent/web/scrapers/wikidata";
