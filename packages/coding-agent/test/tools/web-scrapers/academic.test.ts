...
import { handleArxiv } from "@musepi/pi-coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@musepi/pi-coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@musepi/pi-coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@musepi/pi-coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@musepi/pi-coding-agent/web/scrapers/types";
