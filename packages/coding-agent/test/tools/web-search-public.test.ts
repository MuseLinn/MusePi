...
import { setExcludedSearchProviders } from "@musepi/pi-coding-agent/web/search/provider";
import type { SearchParams } from "@musepi/pi-coding-agent/web/search/providers/base";
import { searchPublicWeb } from "@musepi/pi-coding-agent/web/search/providers/public";
import { SearchProviderError, type SearchProviderId } from "@musepi/pi-coding-agent/web/search/types";
...
const NON_TEST_ENGINES: readonly SearchProviderId[] = ["ecosia", "startpage", "bing", "mojeek"];
