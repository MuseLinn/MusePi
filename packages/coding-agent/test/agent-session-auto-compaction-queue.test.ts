...
import { type AssistantMessage, createAssistantMessageEventStream, fauxAssistantMessage } from "@musepi/pi-ai";
import { getModel, streamSimple } from "@musepi/pi-ai/compat";
