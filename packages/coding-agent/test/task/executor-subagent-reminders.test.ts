...
import { AgentBusyError, type AgentTelemetryConfig, type Tracer } from "@musepi/pi-agent-core";
import { type AssistantMessage, Effort } from "@musepi/pi-ai";
import { Settings } from "@musepi/pi-coding-agent/config/settings";
import type { ExtensionActions, LoadExtensionsResult } from "@musepi/pi-coding-agent/extensibility/extensions/types";
...
} from "@musepi/pi-coding-agent/task/executor";
...
describe("runSubprocess yield reminders", () => {
	...
	const baseOptions = {
		...
		modelRegistry: {
			refresh: async () => {},
		} as unknown as import("@musepi/pi-coding-agent/config/model-registry").ModelRegistry,
		enableLsp: false,
	};
