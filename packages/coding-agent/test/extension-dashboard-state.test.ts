...
import { applyDisabledExtensionsToState } from "@musepi/pi-coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@musepi/pi-coding-agent/modes/components/extensions/types";
