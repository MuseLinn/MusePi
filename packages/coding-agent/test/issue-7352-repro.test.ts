...
import { MnemopiEmbedClient, type MnemopiEmbedWorkerHandle } from "@musepi/pi-coding-agent/mnemopi/embed-client";
import type {
	MnemopiEmbedWorkerInbound,
	MnemopiEmbedWorkerOutbound,
} from "@musepi/pi-coding-agent/mnemopi/embed-protocol";
