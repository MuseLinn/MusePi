...
} from "@musepi/pi-coding-agent/extensibility/legacy-pi-coding-agent-shim";
...
// `@musepi/pi-agent-core/compaction` and the coding-agent barrel does not
...
describe("legacy shim compaction helpers", () => {
	...
	// Issue #7174: `compact` (same `@musepi/pi-agent-core/compaction` module as
