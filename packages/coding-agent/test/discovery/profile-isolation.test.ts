...
import { type Skill, skillCapability } from "@musepi/pi-coding-agent/capability/skill";
import { type SlashCommand, slashCommandCapability } from "@musepi/pi-coding-agent/capability/slash-command";
