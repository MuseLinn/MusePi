...
import {
	...
	parseAgentPluginMcp,
} from "@musepi/pi-coding-agent/discovery/agent-plugin-format";
import {
	clearClaudePluginRootsCache,
	injectPluginDirRoots,
	listClaudePluginRoots,
} from "@musepi/pi-coding-agent/discovery/helpers";
import { getPluginsDir, removeWithRetries } from "@musepi/pi-utils";
import "@musepi/pi-coding-agent/discovery/agent-plugins";
import "@musepi/pi-coding-agent/discovery/claude-plugins";
import type { MCPServer } from "@musepi/pi-coding-agent/capability/mcp";
