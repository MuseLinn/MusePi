...
import { loadCapability, setDisabledProviders } from "@musepi/pi-coding-agent/capability";
import type { ContextFile } from "@musepi/pi-coding-agent/capability/context-file";
import { clearCache } from "@musepi/pi-coding-agent/capability/fs";
import type { Instruction } from "@musepi/pi-coding-agent/capability/instruction";
import type { Prompt } from "@musepi/pi-coding-agent/capability/prompt";
import { type Rule, resetActiveRulesForTests, setActiveRules } from "@musepi/pi-coding-agent/capability/rule";
import { RuleProtocolHandler } from "@musepi/pi-coding-agent/internal-urls/rule-protocol";
import { removeSyncWithRetries } from "@musepi/pi-utils";
import "@musepi/pi-coding-agent/capability/context-file";
import "@musepi/pi-coding-agent/capability/instruction";
import "@musepi/pi-coding-agent/capability/prompt";
import "@musepi/pi-coding-agent/capability/rule";
import "@musepi/pi-coding-agent/discovery/github";
