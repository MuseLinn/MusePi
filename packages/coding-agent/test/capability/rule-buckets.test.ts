...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule } from "@musepi/pi-coding-agent/capability/rule";
import { bucketRules } from "@musepi/pi-coding-agent/capability/rule-buckets";
