...
import { compileRuleCondition } from "@musepi/pi-coding-agent/capability/rule";
import { buildRuleFromMarkdown, createSourceMeta } from "@musepi/pi-coding-agent/discovery/helpers";
