...
const expectedTemplate: TemplateProbeResult = {
	chars: 514_273,
	bytes: 535_150,
	sha256: "298712d2601a3bd2d95da2eafcf05824b6068f70da8afa66f344fc8805d20079",
	stableCache: true,
	assetsRemoved: 0,
};
...
const bundledDependencyStubs: Record<string, string> = {
	"@musepi/pi-utils": 'export const APP_NAME = "omp"; export const isEnoent = () => false;',
	"../../modes/theme/theme":
...
describe("HTML export template", () => {
	...
	test("composes the exact source template once and returns the cached bytes", async () => {
		...
		expect(first).toContain("// Auto-generated by packages/desktop-web/scripts/build-tool-views.ts - DO NOT EDIT");
