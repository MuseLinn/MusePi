...
import type { MarketplacePluginEntry } from "@musepi/pi-coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@musepi/pi-coding-agent/extensibility/plugins/marketplace";
