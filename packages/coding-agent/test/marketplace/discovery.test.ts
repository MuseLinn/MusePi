 ...
 * @musepi/pi-natives (native Rust addon via glob). We cannot call it here.
 *
...
// Kept here to avoid importing helpers.ts (which pulls in @musepi/pi-natives).
...
// Matches getConfigDirName() — single source of truth is in @musepi/pi-utils,
