...
import * as autoThinkingClassifier from "@musepi/pi-coding-agent/auto-thinking/classifier";
...
import { AUTO_THINKING, clampAutoThinkingEffort, resolveProvisionalAutoLevel } from "@musepi/pi-coding-agent/thinking";
