...
import { EDIT_MODE_STRATEGIES } from "@musepi/pi-coding-agent/edit/streaming";
...
import { BUILTIN_DEFAULTS_PROVIDER_ID, type Rule, ruleCapability } from "@musepi/pi-coding-agent/capability/rule";
import type { LoadContext } from "@musepi/pi-coding-agent/capability/types";
// Register all discovery providers as a side effect.
import "@musepi/pi-coding-agent/discovery";
import { TtsrManager } from "@musepi/pi-coding-agent/export/ttsr";
