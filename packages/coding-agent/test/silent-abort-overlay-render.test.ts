...
import type { ObservableSession } from "@musepi/pi-coding-agent/modes/session-observer-registry";
...
function makeSubagentRegistry(sessions: ObservableSession[]) {
	...
	} as unknown as import("@musepi/pi-coding-agent/modes/session-observer-registry").SessionObserverRegistry;
}
