...
import { ACP_TERMINAL_AUTH_FLAG, prepareAcpTerminalAuthArgs } from "@musepi/pi-coding-agent/modes/acp/terminal-auth";
...
import { getConfigRootDir, setAgentDir, VERSION } from "@musepi/pi-utils";
import type { AgentSideConnection, InitializeRequest } from "@musepi/pi-utils/acp";
