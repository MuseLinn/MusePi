...
} from "@musepi/pi-coding-agent/extensibility/plugins/loader";
import type { InstalledPlugin, PluginManifest } from "@musepi/pi-coding-agent/extensibility/plugins/types";
