...
import { renderSearchResult, type SearchRenderDetails } from "@musepi/pi-coding-agent/web/search/render";
import type { SearchResponse } from "@musepi/pi-coding-agent/web/search/types";
