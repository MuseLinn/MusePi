 ...
 * `packages/desktop-app/electron/daemon.cjs`. No Electron import, no GUI.
 *
 * Covers:
...
function loadDaemonModule() {
	delete require.cache[require.resolve("../../desktop-app/electron/daemon.cjs")];
	return require("../../desktop-app/electron/daemon.cjs");
}
