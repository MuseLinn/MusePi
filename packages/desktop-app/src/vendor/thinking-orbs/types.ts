 ...
 * - `waiting`   — the listening waveform, PINNED (no UI-level idle cycle
 *   runs for it): "paused for you" — tool approvals, blocked prompts
 */
export type OrbState = 'working' | 'searching' | 'solving' | 'listening' | 'composing' | 'shaping' | 'waiting';
 ...
 * designs, not a scale factor. 32 is the chat-avatar middle ground.
 */
