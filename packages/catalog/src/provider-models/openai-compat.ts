...
function createBundledStaticModel(
	provider: string,
	baseUrl: string,
	id: string,
	name: string,
...
/**
 * Agnes AI documented chat catalog (CN + global), bundled so both providers
...
/**
 * StepFun Step Plan documented chat catalog (CN + global), bundled for the
 * same reason as the Agnes seeds above. NOTE: step-3.7-flash context/pricing
 * were reconstructed as placeholders after the 2026-08-04 WIP loss (131072 /
 * $0 / text-only) — the StepFun docs were unreachable while writing this;
 * re-verify against the official docs when network allows.
 */
...
export const STEPFUN_GLOBAL_STATIC_MODELS: readonly ModelSpec<"openai-completions">[] = [
	createBundledStaticModel(
		"stepplan-global",
