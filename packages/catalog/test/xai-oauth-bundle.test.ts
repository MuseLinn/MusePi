...
import MODELS_JSON from "@musepi/pi-catalog/models.json" with { type: "json" };
import { CATALOG_PROVIDERS, DEFAULT_MODEL_PER_PROVIDER } from "@musepi/pi-catalog/provider-models/descriptors";
import { buildXaiOAuthStaticSeed } from "@musepi/pi-catalog/provider-models/openai-compat";
