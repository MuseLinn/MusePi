...
const PRESETS: Record<ModeKey, Record<OrbSize, Preset>> = {
  orbits: {
    ...
    32: { speed: 3.35, count: 0.446, size: 2.02 },
    20: { speed: 3.9, count: 0.238, size: 2.4 }
  },
  globe: {
    64: { speed: 2.015, count: 0.42, size: 1.15, extra: { scanMul: 4.08, dimBase: 0.45 } },
    32: { speed: 2.49, count: 0.191, size: 1.59, extra: { scanMul: 4.22, dimBase: 0.45 } },
    20: { speed: 2.665, count: 0.105, size: 1.75, extra: { scanMul: 4.335, dimBase: 0.45 } }
  },
  rubik: {
    64: { speed: 1.82, count: 0.35, size: 1.05 },
    32: { speed: 1.91, count: 0.159, size: 1.67 },
    20: { speed: 1.95, count: 0.088, size: 1.9 }
  },
  wave: {
    64: { speed: 4.388, count: 0.341, size: 1 },
    32: { speed: 4.1, count: 0.169, size: 1.44 },
    20: { speed: 3.998, count: 0.105, size: 1.6 }
  },
  ribbon: {
    64: { speed: 2.34, count: 0.25, size: 0.85, extra: { spin: 0, bandMul: 3.9, wobMul: 1 } },
    32: { speed: 2.91, count: 0.105, size: 1.01, extra: { spin: 0, bandMul: 4.66, wobMul: 1 } },
  ...
  morph: {
    ...
    32: { speed: 2.32, count: 0.533, size: 0.84, extra: { spread: 1.45 } },
