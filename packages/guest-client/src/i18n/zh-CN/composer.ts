export const composer = {
	...
	sketch: "绘画",
	"sketch tool select": "选择",
	"sketch tool pen": "画笔",
	"sketch tool eraser": "橡皮",
	"sketch tool text": "文本",
	"sketch tool shapes": "形状",
	"sketch tool line": "直线",
	"sketch tool arrow": "箭头",
	"sketch tool rect": "矩形",
	"sketch tool ellipse": "椭圆",
	"sketch tool diamond": "菱形",
	"sketch tool triangle": "三角形",
	"sketch tool star": "五角星",
	"sketch tool heart": "心形",
	"sketch thickness": "粗细",
	"sketch color": "颜色",
	"sketch text placeholder": "输入文字…",
	"sketch undo": "撤销",
	"sketch redo": "重做",
	"sketch clear": "清空",
	"sketch done": "完成",
