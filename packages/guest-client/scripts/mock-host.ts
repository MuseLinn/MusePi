 ...
 * serves the canned fixture session to any guest-client guest that joins.
 *
...
ws.onopen = () => {
	...
	console.log("paste the link into the guest-client connect screen (bun ./index.html), Ctrl+C stops the host");
};
