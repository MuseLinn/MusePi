import { encodeSixel } from "@musepi/pi-natives";
import { $env, isBunTestRuntime, isTerminalHeadless } from "@musepi/pi-utils";
...
const CMUX_NOTIFICATION_TITLE = "MusePi";
